              ...
              <div className="flex-row">
                <div className="flex">
                  <div className="w-[85px] h-[85px] rounded-[10px] bg-[#5685FF] bg-opacity-50">
                    <h3 className="text-[#001049] font-JostR400 text-[41px] text-center pt-[12px]">
                      1
                    </h3>
                  </div>
                  <div className="ml-[20px] flex flex-col mt-1">
                    <span className="font-JostM500 xl:text-[40px] md:text-[30px] sm:text-[25px] text-[24px] text-[#001049] xl:w-[400px] lg:w-[290px] md:w-[318px] sm:w-[215px] w-[200px] leading-none ">
                      We have been improving our product{" "}
                    </span>
                    <span className="font-JostM500 xl:text-[40px] md:text-[30px] sm:text-[25px] text-[24px] text-[#5685FF] ">
                      for many years
                    </span>
                  </div>
                </div>
                <div>
                  <div className="lg:ml-[105px] flex flex-col mt-1">
                    <p className="font-JostR400 text-[16px] text-[#2A3354] xl:w-[309px] lg:w-[250px] leading-tight mt-[15px]">
                ...
                <div className="flex lg:mt-4 mt-6">
                  ...
                  <div className="ml-[20px] flex flex-col mt-1">
                    <span className="font-JostM500 xl:text-[40px] md:text-[30px] sm:text-[25px] text-[24px] text-[#001049] leading-none xl:w-[412px] lg:w-[309px] md:w-[240px] w-[180px]">
                      You can practice at any
                    </span>
                    <span className="font-JostM500 xl:text-[40px] md:text-[30px] sm:text-[25px] text-[24px] text-[#5685FF] leading-none">
                ...
                <div className="md:mt-[45px] md:ml-[105px] lg:mb-20 mt-8">
                  <button className="md:w-[190px] bg-[#003FE6] md:h-[62px] h-[48px] w-[98%] rounded-[10px] text-center">
                    <span className="text-white font-JostM500 text-[14px] md:text-[16px]">
                      Get started
                    </span>
                  </button>
                </div>
