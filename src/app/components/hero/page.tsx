            ...
            <div>
              <div className="mt-5">
                <h1 className="text-[#001049] font-JostM500 xxl:text-[80px] xl:text-[75px] lg:text-[60px] text-[48px] leading-tight lg:w-[700px] md:w-[500px] w-[340px]">
                  Develop your skill without dilligence
                </h1>
              </div>
              <div className="mt-5">
                <p className="text-[#001049] font-JostM500 xl:text-[16px] md:text-[14px] xl:w-[500px] lg:w-[440px] w-[340px]">
            ...
            <div className="flex gap-5">
              <div className="xl:w-[295px] xl:h-[295px] lg:w-[250px] lg:h-[250px] bg-[#FF9292] rounded-[40px] justify-center flex">
                <Image
                  ...
                  width={0}
                  height={0}
                  className="m-5 lg:w-[200px] lg:h-[200px] xl:w-[253px] xl:h-[253px]"
                  loading="lazy"
                />
              </div>
