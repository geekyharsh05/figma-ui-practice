    ...
    <section className="mb-20 xxl:mx-20 lg:mx-18 mx-auto mt-[58px] ">
      <div className="flex justify-center items-center">
        <div className="lg:flex-wrap flex-col xxl:w-[1260px] xl:w-[1180px] lg:w-[945px] md:w-[500px] w-[340px] h-auto">
          <div>
            <div>
              <h2 className="text-[#001049] font-JostM500 text-[40px] w-[200px] leading-tight">
                Why we are better than others
              </h2>
              <p className="text-[#2A3354] text-[16px] font-JostR400 w-[260px] mb-[20px] lg:mb-0">
            ...
            <div className="flex rounded-[40px] lg:w-fit w-auto relative box-shadow">
              <div className="flex h-[190px]">
                <div className="md:ml-[40px] mt-[20px] ml-[27px] w-[213px]">
                  <span className="font-JostM500 lg:text-[24px] md:text-[20px] text-[#001049]">
                ...
                <Image
                  ...
                  width={0}
                  height={0}
                  className="lg:w-[200px] lg:h-[200px] xl:w-[253px] xl:h-[253px] md:w-[250px] md:h-[250px] w-[190px] h-[190px] xl:mt-[-25px] mt-[20px] lg:mt-0 md:mt-4 md:absolute md:right-0 lg:relative"
                  loading="lazy"
                />
              </div>
            </div>
            ...
            <div className="flex rounded-[40px] lg:w-fit  box-shadow lg:mt-[-20px] w-auto">
              <div className="flex">
                <div className="md:ml-[40px] mt-[20px] ml-[27px] lg:w-[253px] w-[255px] md:pr-[50px] lg:pr-0">
                  <span className="font-JostM500 lg:text-[24px] md:text-[20px] text-[#001049] leading-tight">
                ...
                <Image
                  ...
                  className="w-[170px] h-[170px] md:w-[190px] md:h-[190px] md:mr-[40px] "
                  loading="lazy"
                />
              </div>
            </div>
