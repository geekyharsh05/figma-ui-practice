    ...
    const mappedItems = DetailCard.map((item, id) => (
      <div
        ...
        className={`mx-auto xl:w-[340px] lg:w-[290px] w-[320px] ${
          id === 1 ? "lg:mt-[106px]" : "lg:mt-[146px]"
        } mt-[146px] bg-[#fafafa] rounded-[40px] box-shadow-card mb-10`}
      >
        <div className="flex justify-center flex-col mx-auto items-center text-center">
          <div className="mt-[40px]">
            <span className="font-JostB700 text-[32px] text-[#001049]">
              {item.mainTitle}
            </span>
            <p className="font-JostM500 text-[16px] text-[2A3354] mt-[20px] w-[262px]">
              {item.mainParagraph}
            </p>
          </div>
          <div className="flex mt-[30px]">
            <h1 className="text-[#5685FF] font-JostB700 text-[80px]">
              {item.price}
            </h1>
            <span className="text-[#2A3354] text-[16px] font-JostR400 mt-[20px] ml-5">
              /{item.month}
            </span>
          </div>
          <div className="mt-[40px]">
            <ul>
              {item.packageDetails.map((data, i) => (
                <li
                  key={i}
                  className="text-[#2A3354] text-[16px] font-JostM500 flex mb-[18px]"
                >
                  <Image
                    src={data.image}
                    alt={data.altTag}
      ...
      <div className="flex justify-center">
        <div className="xxl:w-[1260px] xl:w-[1180px] lg:w-[945px] md:w-[500px] w-[340px] h-auto">
          <div className="text-center relative z-40">
            <h2 className="text-[#001049] font-JostM500 lg:text-[48px] md:text-[38px] text-[28px]">
            ...
            <div className="mt-[52px]">
              <span className="text-[#001049] font-JostM500 text-[16px] mr-[32px]">
                Monthly
              </span>
              ...
              <span className="text-[#001049] font-JostM500 text-[16px] ml-[32px]">
                Yearly
              </span>
            </div>
          </div>
