            ...
            <div className="flex justify-between lg:flex-row flex-col">
              <div>
                ...
                <div className="mt-[26px]">
                  <p className="text-[#001049] font-JostR400 text-[14px] w-[313px]">
                    But I must explane to you how all this mistaken idea of
              ...
              <div className="grid xl:gap-20 lg:gap-14 gap-10 lg:grid-cols-3 grid-cols-2 lg:mt-[68px] md:mt-[58px] mt-[40px] mb-5">
                <div className="lg:ml-[60px]">
                  <ul>
                    <li className="font-JostM500 text-[16px] text-[#001049]">
                      Platform
                    </li>
                    <li className="font-JostR400 text-[14px] text-[#001049] cursor-pointer mt-[20px]">
                      Overview
                    </li>
                    <li className="font-JostR400 text-[14px] text-[#001049] cursor-pointer mt-[20px]">
                      Features
